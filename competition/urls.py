...
from .views import WeaponUpdateView, CompetitionPerformView, ReleaseWeaponView, ReadRecordView, ReadCompetitionResult
from .views import EndCompetitionView
...
urlpatterns = [
	...
	path('perform/<int:pk>/end', EndCompetitionView.as_view(), name="end-competition"),
	path('perform/<int:pk>/release-weapon/<int:weapon_pk>', ReleaseWeaponView.as_view(), name="release-weapon"),
	path('readResult/<int:pk>/<task_id>', ReadCompetitionResult.as_view(), name="read-result"),
	path('readRecord/<int:pk>', ReadRecordView.as_view(), name="read-record"),
